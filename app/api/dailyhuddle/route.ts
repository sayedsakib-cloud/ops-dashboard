  ...
  try {
    ...
    return NextResponse.json({
      ...
      bizops: [
        ...
        metric("Max Approved Time",             br(B.highestPayoutTime, "max"),  bp(B.highestPayoutTime, "max"),  "hrs"),
        metric("Intercom Ticket Solved",        br(B.intercomTickets),           bp(B.intercomTickets),           "number"),
        metric("Max Resolved Duration (ticket)",br(B.intercomMaxTime,  "max"),  bp(B.intercomMaxTime,  "max"),  "hrs"),
      ],
      bizopsEligible: {
        fnProcessed:    metric("FN Processed",                   br(B.totalVerified,  "last"), bp(B.totalVerified,  "last"), "number"),
        eligibleKYC:    metric("Today's Eligible KYC",           br(B.eligibleKYC,    "last"), bp(B.eligibleKYC,    "last"), "number"),
        eligiblePayout: metric("Today's Eligible Payout So Far", br(B.eligiblePayout, "last"), bp(B.eligiblePayout, "last"), "number"),
      },
      cr: [
        metric("Remaining Email",     cr(C.remainingEmail,     "last"), cp(C.remainingEmail,     "last"), "number"),
