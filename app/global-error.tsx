...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <html lang="en">
      <body style={{ margin: 0, fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, sans-serif", background: "#0b1120", color: "#e2e8f0" }}>
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }}>
          <div style={{ maxWidth: 420, width: "100%", textAlign: "center", border: "1px solid #1e293b", borderRadius: 16, padding: 32, background: "#0f172a" }}>
            ...
            <button
              onClick={() => reset()}
              style={{ marginTop: 24, border: "none", borderRadius: 8, padding: "8px 16px", fontSize: 14, fontWeight: 500, cursor: "pointer", background: "#2563eb", color: "#fff" }}
            >
              Try again
            </button>
            {error?.digest && (
