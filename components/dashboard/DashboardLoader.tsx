    ...
    <>
      ...
      {visible ? (
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 18% 62%, rgba(6,52,52,0.9) 0%, #050c16 55%, rgba(28,8,48,0.75) 100%)",
          }}
        >
          ...
          <div className="relative w-32 h-32 flex items-center justify-center">
            ...
            >
              <defs>
                <linearGradient id="loaderArc1" x1="0" y1="0" x2="128" y2="128" gradientUnits="userSpaceOnUse">
                  ...
                  <stop offset="55%"  stopColor="#06b6d4" stopOpacity="1" />
            ...
            <div
              ...
              style={{
                background: "radial-gradient(circle at 35% 35%, #1a3d70 0%, #0c1829 100%)",
                boxShadow: "0 0 32px rgba(6,182,212,0.25), inset 0 0 20px rgba(14,165,233,0.08)",
              }}
            >
              {/*
              ...
              */}
              <svg viewBox="0 0 40 40" className="w-10 h-10" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="6"  y="24" width="5"  height="10" rx="1" fill="#38bdf8" opacity="0.9" />
                <rect x="14" y="18" width="5"  height="16" rx="1" fill="#38bdf8" />
                <rect x="22" y="12" width="5"  height="22" rx="1" fill="#818cf8" />
                <rect x="30" y="20" width="5"  height="14" rx="1" fill="#818cf8" opacity="0.7" />
                <path d="M8 22 L16 16 L24 10 L32 18" stroke="#06b6d4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          ...
          <p
            ...
            style={{ color: phase >= 2 ? "#06b6d4" : "#64748b" }}
          >
            {MSGS[phase]}
          </p>
          ...
          <div className="flex gap-2 mt-4">
            {[0, 1, 2].map(i => (
              <div
                ...
                style={{
                  background:   phase > i ? "#06b6d4" : "#1e2d40",
                  boxShadow:    phase > i ? "0 0 6px rgba(6,182,212,0.6)" : "none",
